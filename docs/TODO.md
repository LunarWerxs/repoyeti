...
- [ ] **🧑 P1 — relocate root planning docs** (F5). `gem.md`, `gpt.md`, `git-orchestrator-brief-v2.md`, `MARCHING_ORDERS.md` sit at repo root (reads as unfinished to outsiders). Move to `docs/archive/` and promote any durable architecture into an `ARCHITECTURE.md`. (This `TODO.md` is now the roadmap — link it from the README.)
